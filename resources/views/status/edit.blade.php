        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-4 mb-3">
                ...
                <select class="form-select" name="kategori">
                    ...
                    <option value="normal" {{ $data['kategori'] == 'normal' ? 'selected' : '' }}>Aset Normal</option>
                    <option value="rusak" {{ $data['kategori'] == 'rusak' ? 'selected' : '' }}>Aset Rusak</option>
                </select>
                <div class="form-text">Kategori status untuk aset rusak atau normal</div>
            </div>
            <div class="col-lg-4 mb-3">
                <label class="font-weight-bold">Biaya Perbaikan</label>
                <input type="text" class="form-control" name="biaya_perbaikan" value="{{ $data['biaya_perbaikan'] }}" required>
