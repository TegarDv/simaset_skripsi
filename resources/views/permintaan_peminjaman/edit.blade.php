...
<div class="modal-header">
    <h1 class="modal-title fs-5" id="staticBackdropLabel">Edit Data Permintaan Peminjaman</h1>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<form class="row g-3" action="{{ route('transaksi-permintaan.update', ['transaksi_permintaan' => $data->id]) }}" method="POST" id="updateForm">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="mb-2">
                    ...
                    <input type="date" class="form-control" name="tanggal" value="{{ $data['tanggal_permintaan'] }}" required>
                </div>
                <div class="mb-3">
