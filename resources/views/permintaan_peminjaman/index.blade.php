...
@section('content')
<h4 class="text-start">Transaksi Permintaan Peminjaman</h4>
<div class="card shadow-lg">
    <h5 class="card-header">Data Permintaan Peminjaman</h5>
    <div class="card-body">
        <div class="alert alert-info d-flex align-items-center" style="color: #000;"  role="alert">
            ...
            <div>
                Berisi list data permintaan peminjaman aset.
            </div>
        </div>
    </div>
...
<div class="modal fade" id="detailModal" tabindex="-1" aria-labelledby="detailModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-focus="false" tabindex="-1">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <!-- Modal content will be loaded here -->
        </div>
    ...
    $(document).ready(function () {
        var datatables = $('#data_assets').DataTable({
            ...
            columns: [
                ...
                { data: 'column2', width: '10%', name: 'column2', title: 'Tanggal' },
                { data: 'column3', width: '10%', name: 'column3', title: 'Kode Aset' },
                { data: 'column4', width: '10%', name: 'column4', title: 'Status Permintaan' },
                { data: 'column5', width: '10%', className: 'text-center', name: 'column5', title: 'Action' },
            ],
        ...
        $('.create-btn').on('click', function () {
            ...
            $.ajax({
                url: '/transaksi-permintaan/create', // Assuming this is the route for loading the create form
                type: 'GET',
        ...
        $('#data_assets').on('click', '.view-app-btn', function () {
            ...
            $.ajax({
                url: '/transaksi-permintaan/' + appId,
                type: 'GET',
                success: function (response) {
        ...
        $('#data_assets').on('click', '.edit-app-btn', function () {
            ...
            $.ajax({
                url: '/transaksi-permintaan/' + appId + '/edit',
                type: 'GET',
                success: function (response) {
        ...
        $('#data_assets').on('click', '.delete-app-btn', function () {
            ...
            Swal.fire({
                ...
                text: "Anda tidak dapat mengembalikan tidakan ini jika setuju!",
                icon: 'warning',
