@extends('layouts')
@section('title', 'SIMASET - Lokasi Aset')
@section('custom_css')
...
<section id="base">
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <p>
                    <h2 class="text-start">Lokasi Aset</h2>
        ...
        <div class="container rounded p-1">
            <div class="card shadow-lg">
                <h5 class="card-header text-warning-emphasis">Lokasi Aset</h5>
                <div class="card-body">
    ...
    $(document).ready(function () {
        var datatables = $('#data_assets').DataTable({
            ...
            columns: [
                ...
                { data: 'column2_aset', width: '10%', name: 'column2_aset', title: 'Nama Lokasi' },
                { data: 'column3_aset', width: '10%', name: 'column3_aset', title: 'Waktu' },
                { data: 'column4_aset', width: '10%', className: 'text-center', name: 'column4_aset', title: 'Action' }
            ],
