...
$("select[name='message_type']").on('change', function () {
    ...
    switch (value) {
        case "text":
            html += '<div class="col-12"><div class="mb-3"><label class="form-label">Message</label><textarea name="message" rows="6" class="form-control" placeholder="Example : {{Hai|Hello}} {name}, your number is {number} registered at wisender.com" required></textarea></div></div>';
            break;
        case "media":
        ...
        case "list":
            ...
            html += '<div class="col-12"><div class="mb-3"><label class="form-label">Message</label><textarea name="message" placeholder="Example : {{Hai|Hello}} {name}, your number is {number} registered at wisender.com" rows="6" class="form-control" required></textarea></div></div>';
            html += '<div class="col-12"><div class="mb-3"><label class="form-label">Footer</label><input name="footer" class="form-control" required autocomplete="off"></div></div>';
